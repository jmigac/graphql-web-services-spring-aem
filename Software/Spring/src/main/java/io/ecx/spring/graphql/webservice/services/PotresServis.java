...
public class PotresServis {
    ...
    public void spremi(final PotresModel potresModel){
        this.dnevnikRadaServis.spremi(DnevnikRada
                .builder()
                .radnja(DnevnikRadaHelper.AKCIJA_UPISA_POTRESA_U_BAZU)
    ...
    public List<PotresModel> dohvatiSve(){
        this.dnevnikRadaServis.spremi(DnevnikRada
                .builder()
                .radnja(DnevnikRadaHelper.AKCIJA_DOHVATA_SVIH_POTRESA)
                .vrijemeRadnje(new Date())
                .build());
    ...
    public List<PotresModel> dohvatiSve(final int limit){
        this.dnevnikRadaServis.spremi(DnevnikRada
                .builder()
                .radnja(DnevnikRadaHelper.AKCIJA_DOHVATA_S_LIMITOM)
                .vrijemeRadnje(new Date())
                .build());
    ...
    public boolean postojiLiPotres(final String id){
        this.dnevnikRadaServis.spremi(DnevnikRada
                .builder()
                .radnja(DnevnikRadaHelper.PROVJERA_POSTOJANOSTI_POTRESA)
                .vrijemeRadnje(new Date())
                .build());
    ...
    public PotresModel dohvatiPotresModelPoIdentifikatoruEventa(final String eventId){
        this.dnevnikRadaServis.spremi(DnevnikRada
                .builder()
                .radnja(DnevnikRadaHelper.AKCIJA_DOHVATA_POTRESA_PO_ID)
                .vrijemeRadnje(new Date())
                .build());
    ...
    public PotresModel azurirajObjektPotresa(final PotresModel potresModel){
        this.dnevnikRadaServis.spremi(DnevnikRada
                .builder()
                .radnja(DnevnikRadaHelper.AKCIJA_AZURIRANJA_POTRESA)
                .vrijemeRadnje(new Date())
                .build());
    ...
    public void brisanjeObjektaPotresa(final String eventId) throws BrisanjeNepostojanogModela{
        if(this.repozitorij.existsPotresModelById(eventId)){
            this.dnevnikRadaServis.spremi(DnevnikRada
                    .builder()
                    .radnja(DnevnikRadaHelper.AKCIJA_BRISANJA_POTRESA)
                    .vrijemeRadnje(new Date())
                    .build());
